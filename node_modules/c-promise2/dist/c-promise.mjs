 ...
 * @type {Function}
 */
var ReactComponent = CPromise.ReactComponent;
/**
 * make CPromise function atomic
 * @type {Function}
 */
var atomic = CPromise.atomic;
/**
 * append `done` chain to the resulting promise of the decorated method
 * @type {Function}
 */
var done = CPromise.done;
/**
 * timeout decorator
 * @type {Function}
 */
...
export { AbortController_1 as AbortController, AbortControllerEx_1 as AbortControllerEx, CPromise_1 as CPromise, CanceledError_1 as CanceledError, E_REASON_CANCELED_1 as E_REASON_CANCELED, E_REASON_DISPOSED_1 as E_REASON_DISPOSED, E_REASON_TIMEOUT_1 as E_REASON_TIMEOUT, E_REASON_UNMOUNTED_1 as E_REASON_UNMOUNTED, ReactComponent, async, atomic, cancel, canceled, done, innerWeight, label, listen, progress, promisify, timeout };
